import { Twitter, Instagram, Linkedin, Mail, Phone , Github ,X} from "lucide-react"
...
{/*           
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
              ...
              <div className="flex items-center gap-2 mb-4">
                <div className="w-8 h-8 rounded-full overflow-hidden flex-shrink-0">
                  <Image
                    ...
                    alt="Mayank Saini Portfolio"
                    width={32}
                    height={32}
                    className="object-cover"
                  />
                </div>
                <span className="text-lg md:text-xl font-bold">Mayank's Folio</span>
              </div>
              <p className="text-gray-400 mb-6 text-sm leading-relaxed">
                Full-stack web developer passionate about building user-centric applications. Expertise in React,
                Next.js, Node.js, and modern web technologies.
              </p>
              <div className="flex gap-3">
                <a
                  href="https://twitter.com/mayanksaini18"
                  target="_blank"
                ...
                <a
                  href="https://instagram.com/mayanksaini18"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                ...
                <a
                  href="https://linkedin.com/in/mayanksaini18"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                ...
                <a href="https://github.com/mayanksaini18"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10  rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                >
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                ...
                <li>
                  <a href="mailto:mayanksaini0416@gmail.com" className="hover:text-white transition-colors">
                    Contact
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a
                    href="https://mayank-dev-folio.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <a href="mailto:mayanksaini0416@gmail.com" className="hover:text-white transition-colors">
                    mayanksaini0416@gmail.com
                  </a>
                </li>
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4" />
                  <a href="tel:+915600669310" className="hover:text-white transition-colors">
                    +91-9310292448
                  </a>
                </li>
              </ul>
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>Made by Mayank Saini - Powered by V0</p>
          </div>
        </div>
      </div>
    </footer>
