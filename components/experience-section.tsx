  ...
  const experiences = [
    {
      ...
      description:
        "Building and improving responsive client-facing interfaces. Collaborating with cross-functional teams on design and development. Converting Figma designs into production-ready UI components.",
    ...
    },
    {
      ...
      title: "Bulding BuitX",
      description:
        "Took ownership of product planning, documentation, and requirement organization. Conducted product research and competitive analysis. Managed execution, communication, and accountability across team.",
      icon: "/images/company.png",
    },
    {
      period: "Current",
      title: "B.Sc. Computer Science (AI & Cybersecurity)",
      description:(
        <>
    Undergraduate student at <strong>Indian Institute of Technology(IIT), Patna</strong>. 
    Building strong fundamentals in data structures, algorithms, full-stack development, 
    and applied cybersecurity concepts.
  </>
      ),
    ...
    },
    {
      ...
      description:
        "Completed specialized training in Computer Science and AI at PW Institute of Innovation. Focused on modern web development practices and AI integration.",
