  ...
  const projects = [
    {
      ...
      description:
      "Developed a responsive agency website using modular, scalable architecture. Implemented smooth UX with motion-based interactions and fast load times using Next.js Server Components.",
      tag: "Next Js",
    ...
    },
    {
      ...
      description:
        "Built an end-to-end AI-powered resume analyzer that converts raw text/PDF resumes into interactive dashboards. Integrated Google Gemini API with a Node.js proxy server for secure key handling.",
      tag: "Gemini API",
      logo: "/images/studio-logo.svg",
      bgColor: "bg-[#6366F1]",
      illustration: "/images/studio-workspace.svg",
      link: "https://resume-dashboard-generator.vercel.app/",
    },
  ]
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            ...
            <span className="bg-[#FFC224] text-black px-3 py-1 inline-block">development portfolio</span>
          </h2>
        </div>
