      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
        <div className="flex justify-center">
          <div className="relative w-full max-w-lg aspect-square border-[4px] border-black rounded-full overflow-hidden bg-[#FF6B6B] shadow-[-8px_8px_0px_0px_rgba(0,0,0,1)]">
            <Image src="/images/about-me.svg" alt="About Mayank" fill className="object-cover" />
          </div>
        </div>
        ...
        <div className="space-y-6 md:space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              I'm a creative and innovative web developer passionate about building responsive, user-centric
              applications. With expertise in modern frontend and backend technologies, I transform ideas into
          ...
          <div className="space-y-6">
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">End-to-end Project Ownership</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Hands-on experience in planning, execution, and delivery of web applications from concept to
                  production.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="text-lg md:text-xl font-bold mb-2">Full-Stack Development</h3>
                <p className="text-gray-600 text-sm md:text-base">
                  Proficient in Next.js, React, Node.js, and modern web technologies. Strong foundation in data
